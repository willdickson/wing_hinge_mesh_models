...
if __name__ == '__main__':
    ...
    period = 0.5
    ii_sclerite_amplitude = np.deg2rad(40)
    ii_sclerite_phase = np.deg2rad(0.0)
    ii_sclerite_offset = -ii_sclerite_amplitude 
    ...
    while not done:
        ...
        ii_sclerite_setpos, ii_sclerite_setvel = sin_motion(
                data.time, 
                ii_sclerite_amplitude, 
                ii_sclerite_phase, 
                ii_sclerite_offset, 
                period
                )
        data.actuator('ii_sclerite_position').ctrl = ii_sclerite_setpos
        data.actuator('ii_sclerite_velocity').ctrl = ii_sclerite_setvel
